...
@Component({
  selector: 'app-expire-quote',
  templateUrl: './expire-quote.component.html',
  styleUrls: ['./expire-quote.component.css']
})
export class ExpireQuoteComponent implements OnInit {
  ...
  onGetQuotesList(){
    let UrlLink =`${this.ApiUrl2}getExpireQuoteData`;
    let ReqObj ={
      "applicationid": "1",
      "loginid": "95222222",
      "branchcode": "31",
